  ...
  [
    {
      ...
      budget_min: 1500,
      budget_max: 2500,
      departure_date: "21/07/2022".to_date,
      return_date: "23/08/2022".to_date,
      max_capacity: 6,
      user: User.first,
  ...
  [
    {
      ...
      budget_min: 1500,
      budget_max: 3000,
      departure_date: "20/08/2022".to_date,
      return_date: "17/09/2022".to_date,
      max_capacity: 6,
      user: User.all.sample,
  ...
  [
    {
      ...
      budget_min: 350,
      budget_max: 400,
      departure_date: "4/09/2022".to_date,
      return_date: "6/09/2022".to_date,
      max_capacity: 6,
      user: User.all.sample,
  ...
  [
    {
      ...
      budget_min: 2500,
      budget_max: 3000,
      departure_date: "10/09/2022".to_date,
      return_date: "25/09/2022".to_date,
      max_capacity: 4,
      user: User.all.sample,
  ...
  [
    {
      ...
      budget_min: 200,
      budget_max: 700,
      departure_date: "18/10/2022".to_date,
      return_date: "06/11/2022".to_date,
      max_capacity: 6,
      user: User.all.sample,
  ...
  [
    {
      ...
      budget_min: 400,
      budget_max: 1000,
      departure_date: "01/10/2022".to_date,
      return_date: "06/10/2022".to_date,
      max_capacity: 6,
      user: User.all.sample,
  ...
  [
    {
      ...
      budget_max: 400,
      departure_date: "4/09/2022".to_date,
      return_date: "14/09/2022".to_date,
      max_capacity: 4,
      user: User.all.sample,
      tag_list: ["Europe", "Party", "Chill"]
    },
  ...
  [
    {
      ...
      budget_min: 2000,
      budget_max: 3000,
      departure_date: "10/10/2022".to_date,
      return_date: "24/11/2022".to_date,
      max_capacity: 4,
      user: User.all.sample,
      tag_list: ["America", "Cultural", "Party"]
    },
  ...
  [
    {
      ...
      price: 100,
      start_date: "21/07/2022".to_date,
      end_date: "28/07/2022".to_date,
  ...
  [
    {
      ...
      price: 800,
      start_date: "29/07/2022".to_date,
      end_date: "04/08/2022".to_date,
  ...
  [
    {
      ...
      price: 200,
      start_date: "05/08/2022".to_date,
      end_date: "20/08/2022".to_date,
  ...
  [
    {
      ...
      price: 280,
      start_date: "21/08/2022".to_date,
      end_date: "22/08/2022".to_date,
